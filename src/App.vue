...
export default {
  components: {
   SliderBar:defineAsyncComponent(()=>import("./shared/component/MainSliderBar.vue")),
   HeaderBar:defineAsyncComponent(()=>import("./shared/component/MainHeaderBar.vue")),
